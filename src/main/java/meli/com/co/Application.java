...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("mutante: "+ a.searchMutantADN(new String []{"TTGTGA","CAGTGC","TTATTT","AGACGG","GCGTCA","TCACTG"}));
        //System.out.println("mutante: "+a.searchMutantADN(new String []{"ATGCGA","CAGTGC","TTATGT","AGAAGG","CCCCTA","ATGCGG"}));
        System.out.println("mutante: "+a.searchMutantADN(new String []{"AAAAAA","AAGTGC","ATCTTT","AAAAGG","GCGTCA","TCCCTG"}));
    ...
    private boolean searchMutantADN(String[] dnaSecuence) {
    ...
    private void indexSequence(String word) {
        if (this.hashTable.containsKey(word)) {
            this.hashTable.put(word, this.hashTable.get(word).intValue() + 1);
        } else {
            this.hashTable.put(word, Integer.valueOf(1));
        }
    }
